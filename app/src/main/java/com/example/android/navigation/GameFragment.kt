...
class GameFragment : Fragment() {
    ...
    private val questions: MutableList<Question> = mutableListOf(
        ...
        Question(
            ...
            answers = listOf("Gradle", "Griddle", "Growled", "Gargoyle")
        ),
        Question(
            text = "Android vector format?",
            answers = listOf("VectorDrawable", "AndroidDrawable", "DrawableVector", "AndroidVector")
        ),
        Question(
        ...
        Question(
            ...
            answers = listOf("<layout>", "<binding>", "<data-binding>", "<blinding>")
        )
    )
        ...
        binding.submitButton.setOnClickListener @Suppress("UNUSED_ANONYMOUS_PARAMETER") {
            ...
            if (-1 != checkedId) {
                ...
                if (answers[answerIndex] == currentQuestion.answers[0]) {
                    ...
                    navController.navigate(GameFragmentDirections.actionGameFragmentToGameOverFragment2())
                }
            }
        }
        return binding.root
